...
def create_board():  # funcion to create the board
    ...
    for c in range(colums):
        for r in range(rows):
            pygame.draw.rect(
                screen,
                blue,
                (c * sqauresize, r * sqauresize + sqauresize, sqauresize, sqauresize),
            )
            pygame.draw.circle(
                screen,
                black,
                (
                    int(c * sqauresize + sqauresize / 2),
                    int(r * sqauresize + sqauresize + sqauresize / 2),
                ),
                radius,
            )
        ...
        for r in range(rows):
            if board[r][c] == PLAYER_PIECE:
                pygame.draw.circle(
                    ...
                    (
                        int(c * sqauresize + sqauresize / 2),
                        height - int(r * sqauresize + sqauresize / 2),
                    ),
                    radius,
                )
